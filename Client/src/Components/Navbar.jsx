...
function Navbar() {
  ...
  return (
    <div className='flex justify-between item-center py-5 mx-8 sm:mx-20 xl:mx-32  '>
        ...
        <button  onClick={() => navigate('/blog')} className='flex item-center gap-2 rounded-full text-sm cursor-pointer bg-primary text-white px-10 py-2.5 hover:scale-102'>Login
